...
1. What is the purpose of using _sessions_?
  Sessions allow us to persist authentication information across requests and store client information with no need to re-enter credentials on every new request.

1. What does bcrypt do to help us store passwords in a secure manner.
  bcrypt allows us to hash and compare passwords.
